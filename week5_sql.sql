...
insert into aipgroup.product (product_nm , description , reg_date) values ('Pasta', 'Best Pasta in Sydney', Now());
...
UPDATE aipgroup.product set product_nm = 'Beef Piza'  , description = 'Best Pizza in Australia'  where product_id = 1;
