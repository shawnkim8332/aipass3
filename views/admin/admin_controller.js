//Auth Service to check admin user logins
angular.module('frontApp').factory('AuthService', function($http, $q) {
	return {
		authLogin:function() {
...
//file upload service
angular.module('frontApp').factory('FileUploadService', function($http, $q, Upload) {
	return {
...
//admin product list page controller
angular.module('frontApp').controller('ProductListController', ['$scope', '$http', '$window', 'AuthService', '$location', function($scope, $http, $window, AuthService, $location){
...
angular.module('frontApp').controller('ProductDetailController', ['$scope', '$http', '$location', '$window', '$routeParams', 'AuthService', 'FileUploadService', function($scope, $http, $location, $window, $routeParams, AuthService, FileUploadService){
	var userToken = localStorage.getItem("token");
	if(userToken) {
		//check for admin user
		var promise = AuthService.authLogin();
		...
		$scope.updateProduct = function (){
			...
			if (vm.file) { 
				...
				var promise = FileUploadService.upload(vm.file); 
...
angular.module('frontApp').controller('ProductCreationController', ['$scope', '$http', '$location', '$window', '$routeParams', 'AuthService', 'FileUploadService', function($scope, $http, $location, $window, $routeParams, AuthService, FileUploadService){
	var userToken = localStorage.getItem("token");
	if(userToken) {
		var promise = AuthService.authLogin();
		promise.then(function(isAuth) {
